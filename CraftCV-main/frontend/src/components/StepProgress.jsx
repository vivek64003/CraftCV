...
const StepProgress = ({ progress }) => {
  return (
    ...
    border border-white/10'>
        ...
        <div className=' absolute inset-0 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 snimate-pulse'/>

        {/* Main progress bar */}
        <div className=' relative h-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-violet-600 
        animate-flow bg-[length:200%_100%] trasition-all duration-700 ease-out rounded-full overflow-hidden
         animate-pulse-glow' style={{width: `${progress}%`}}>
            ...
            {/**Animated bubbles */}
            <div className=' absolute inset-0 capacity-80'>
                {[...Array(8)].map((_,i) => (
    ...
    <div className=' flex justify-between items-center mt-3'>
        <div className=' text-cs font-bold text-white/60'>
        {progress < 25 
        ? "Getting Started"
            : progress < 50 
            ? "Making Progress"
