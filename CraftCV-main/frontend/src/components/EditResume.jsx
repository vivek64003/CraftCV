...
import { AlertCircle, ArrowLeft, Check, Download, Loader2, Palette, Trash2, Save } from 'lucide-react'
import axiosInstance from '../utils/axiosInstance'
import { API_PATHS } from '../utils/apiPaths'
import StepProgress from './StepProgress'
import {ProfileInfoForm, ContactInfoForm, WorkExperienceForm, EducationDetailsForm, SkillsInfoForm, ProjectDetailForm, CertificationInfoForm, AdditionalInfoForm} from './Forms'
    ...
    <DashboardLayout>
        ...
        <Modal isOpen={openThemeSelector} onClose={() => setOpenThemeSelector(false)}
          ...
          actionBtnText={isDownloading ? "Generating..."
            : downloadSuccess ? "Downloded!" : "Download PDF"}
