...
import { Award, Check, Clock, Edit, TrendingUp, Zap, Trash2 } from "lucide-react";
        ...
        user && (
            <div className={cardStyles.profileCard}>
                <div className={cardStyles.profileInitialsContainer}>
                    <span className={cardStyles.profileInitials}>
    ...
    <div className={`group h-auto md:h-[300px] lg:h-[320px] flex flex-col bg-white border-2 overflow-hidden 
      ...
      {thumbnailImg ? (
        <div className=" relative w-full h-full overflow-hidden">
          ...
          object-cover group-hover:scale-110 transition-tranform duration-700" />

          <div className=" absolute inset-0 bg-gradient-to-t from-white/00 bia-transparent
           to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

           {isSelected && (
            <div className=" absoulte inset-0 bg-violet-500/10 flex items-center justify-center">
